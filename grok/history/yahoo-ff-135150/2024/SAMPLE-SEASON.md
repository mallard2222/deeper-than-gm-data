# Yahoo Fantasy Football sample season: 8Deep 2024

- League: 8Deep
- Current league lineage: `yahoo-ff-135150` (kept separate from Deeper Than)
- Season league ID: `196758`
- Custom route: `https://football.fantasysports.yahoo.com/league/8deepleague/2024`
- Yahoo route: `https://football.fantasysports.yahoo.com/2024/f1/196758`
...
- The all-teams transactions view is paginated; `transactions.yml` is the first visible 25-record page, not a complete season ledger.
- The Vaqueros-filtered view preserves the 15 visible records Yahoo rendered (Sep 16–Dec 15); older or additional rows were not exposed in that view.
- Yahoo's trade filter exposes transaction-side rows rather than a normalized two-sided ledger; only the two visible sides/records are documented.
- Yahoo's raw draft capture preserves the complete visible 20-round draft table; the markdown highlights Vaqueros picks.
